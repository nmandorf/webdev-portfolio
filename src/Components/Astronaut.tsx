...
export function Astronaut(props: ModelProps) {
    const group = useRef<any>(null)
    const { nodes, materials, animations } = useGLTF(resolveModel("tenhun_falling_spaceman_fanart.glb")) as any
    ...
    return (
        <group ref={group} {...props} dispose={null} rotation={[-Math.PI / 2, -.2, 2.2]} scale={props.scale || 0.3} position={props.position||[1.3, -1, 0]}>
